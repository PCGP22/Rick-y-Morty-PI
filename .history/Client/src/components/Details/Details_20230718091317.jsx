...
function Details({onSearch, logout, addFav, removeFav, myFavorites}) {
  const {id} = useParams();
  ...
  function handleFavorite() {
    if(isFav){
      ...
      setIsFav(true)
      addFav({id: +pj.id, status: pj.status, name: pj.name, image: pj.image, species: pj.species, origin: pj.origin, gender: pj.gender  })
    }
  }
