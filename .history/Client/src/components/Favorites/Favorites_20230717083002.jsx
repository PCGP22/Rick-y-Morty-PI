    ...
    <div className="favorites__filterBar">
      ...
      <div>
        ...
        <div className='container__cards'>
          {myFavorites.length === 0 ? <p className="container__alt">You can see here your favorite characters, go to the main page and click those hearts ❤️</p>:
          myFavorites?.map(({...c})=>{
            return <Card  {...c} key={c.id} onClose={removeFav}/>
          })
        }
        </div>
      </div>
