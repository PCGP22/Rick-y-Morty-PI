...
function SearchBar({onSearch}) {
  ...
  return (
    <div className="searchBar__container">
         <input className="searchBar__input" onKeyDown={handleKeyDown} type='search' value={id} onChange={(e)=>setId(e.target.value)} placeholder="Search by ID (1-826)" autoFocus pattern='/1-826/i'/>
